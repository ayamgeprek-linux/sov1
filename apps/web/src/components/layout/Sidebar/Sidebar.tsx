...
export function Sidebar({
  ...
  const adminMenuItems = [
    ...
    { id: 'master', label: 'Data Master', icon: 'inventory_2' },
    { id: 'mapping', label: 'Mapping Barcode', icon: 'qr_code_scanner' },
    { id: 'progress', label: 'Monitor Progress', icon: 'query_stats' },
    { id: 'history', label: 'Riwayat SO', icon: 'history' },
    { id: 'report', label: 'Laporan', icon: 'description' },
    { id: 'audit', label: 'Audit Log', icon: 'list_alt' },
    { id: 'backup', label: 'Backup & Restore', icon: 'backup' }
  ]

  const petugasMenuItems = [
    { id: 'petugas-dashboard', label: 'Dashboard Petugas', icon: 'dashboard' },
    { id: 'petugas-so', label: 'Scan Barang', icon: 'barcode_scanner' },
    { id: 'petugas-progress', label: 'Riwayat Scan', icon: 'history' }
  ]
    ...
    >
      ...
      <div className={styles.user}>
        ...
        <div className={styles.userInfo}>
          ...
          <span className={`
            ${styles.userRole}
            ${role === 'admin' ? styles.roleAdmin : styles.rolePetugas}
          `}>
